...
function reportMonthlyAdvance($start_date, $end_date,$prcss, $site)
{
	if (!empty($site)) {
        // code...
		if($prcss == "CSR")
		{
			//without purchase
			//$query = "Select count(ic_id) from srvcrqst where ic_crtd_date between :start and :end and ic_status in('Done', 'Closed') and prcss_no like '%$prcss%' and ic_site = '$site' and DATEDIFF(ic_rqst_date,done_date) > 0  and ic_rqst not in('Software Purchase', 'Hardware Purchase', 'License Renewal', 'Renewal License' )";
			//with purchase
			$query = "Select count(ic_id) from srvcrqst where ic_crtd_date between :start and :end and ic_status in('Done', 'Closed') and prcss_no like '%$prcss%' and ic_site = '$site' and DATEDIFF(ic_rqst_date,done_date) > 0 ";
...
function reportMonthlyOnTime($start_date, $end_date,$prcss, $site)
{
	if (!empty($site)) {
        // code...
		if($prcss == "CSR")
...
function reportMonthlyDelay($start_date, $end_date,$prcss, $site)
{
	if (!empty($site)) {
        // code...
		if($prcss == "CSR")
...
function reportMonthlyPrcssSupportStatus($start_date, $end_date, $prcss, $site, $status){

    if (!empty($site)) {
        // code...
        $query = "Select count(ic_id) from srvcrqst where ic_crtd_date between :start and :end and prcss_no like '%$prcss%' and ic_site = '$site' and ic_rqst not in('Software Purchase', 'Hardware Purchase', 'Renewal License','License Renewal' ) and ic_status in('$status') ";
        //$query = "Select count(ic_id) from srvcrqst where ic_crtd_date between :start and :end and ic_status in('New Request','Assigned', 'Work in Progress', 'Done', 'Closed') and prcss_no like '%$prcss%' and ic_site = '$site' ";
    }else{
        $query = "Select count(ic_id) from srvcrqst where ic_crtd_date between :start and :end and prcss_no like '%$prcss%' and ic_rqst not in('Software Purchase', 'Hardware Purchase', 'Renewal License', 'License Renewal') and ic_status in('$status')  ";
        //$query = "Select count(ic_id) from srvcrqst where ic_crtd_date between :start and :end and ic_status in('New Request','Assigned', 'Work in Progress', 'Done', 'Closed') and prcss_no like '%$prcss%'  ";
    }
...
function reportMonthlyPrcssPurchaseStatus($start_date, $end_date, $prcss, $site, $status){

    if (!empty($site)) {
        // code...
        $query = "Select count(ic_id) from srvcrqst where ic_crtd_date between :start and :end and prcss_no like '%$prcss%' and ic_site = '$site' and ic_rqst in('Software Purchase', 'Hardware Purchase', 'Renewal License' ) and ic_status in('$status')";
        //$query = "Select count(ic_id) from srvcrqst where ic_crtd_date between :start and :end and ic_status in('New Request','Assigned', 'Work in Progress', 'Done', 'Closed') and prcss_no like '%$prcss%' and ic_site = '$site' ";
    }else{
        $query = "Select count(ic_id) from srvcrqst where ic_crtd_date between :start and :end and prcss_no like '%$prcss%' and ic_rqst in('Software Purchase', 'Hardware Purchase', 'Renewal License') and ic_status in('$status')";
        //$query = "Select count(ic_id) from srvcrqst where ic_crtd_date between :start and :end and ic_status in('New Request','Assigned', 'Work in Progress', 'Done', 'Closed') and prcss_no like '%$prcss%'  ";
    }
...
function reportMonthlyIndirect($start_date, $end_date, $prcss, $site){

    if (!empty($site)) {
        // code...
        $query = "Select count(ic_id) as count, ic_rqst from srvcrqst where ic_crtd_date between :start and :end and ic_status in('New Request','Assigned', 'Work in Progress', 'Done', 'Closed') and prcss_no like '%$prcss%' and ic_site = '$site' GROUP BY ic_rqst ";
        //$query = "Select count(ic_id) from srvcrqst where ic_crtd_date between :start and :end and ic_status in('New Request','Assigned', 'Work in Progress', 'Done', 'Closed') and prcss_no like '%$prcss%' and ic_site = '$site' ";
    }else{
        $query = "Select count(ic_id) as count, ic_rqst from srvcrqst where ic_crtd_date between :start and :end and ic_status in('New Request','Assigned', 'Work in Progress', 'Done', 'Closed') and prcss_no like '%$prcss%' GROUP BY ic_rqst ";
        //$query = "Select count(ic_id) from srvcrqst where ic_crtd_date between :start and :end and ic_status in('New Request','Assigned', 'Work in Progress', 'Done', 'Closed') and prcss_no like '%$prcss%'  ";
    }
