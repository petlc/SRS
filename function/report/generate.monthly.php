...
$objPHPExcel->getActiveSheet()->getStyle("A$row:G$row")->applyFromArray($bold);
...
$col++;
$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $monthly_lcns_rnrl_report);
$row++;
*/
