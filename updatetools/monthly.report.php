...
function Generate($email,$email_cc)
{
    ...
    foreach ($sites as $site) {
        ...
        foreach ($months as $month) {
            ...
            $monthly_csr_report_Support_adv = reportMonthlyAdvance($start_date, $end_date, 'CSR', $site);
            $monthly_csr_report_Support_ontime = reportMonthlyOnTime($start_date, $end_date, 'CSR', $site);
            $monthly_csr_report_Support_delay = reportMonthlyDelay($start_date, $end_date, 'CSR', $site);
			...
			$monthly_cpr_report_Support_adv = reportMonthlyAdvance($start_date, $end_date, 'CPR', $site);
            $monthly_cpr_report_Support_ontime = reportMonthlyOnTime($start_date, $end_date, 'CPR', $site);
            $monthly_cpr_report_Support_delayinComplted = reportMonthlyDelay($start_date, $end_date, 'CPR', $site);
			...
			$monthly_drr_report_Support_adv = reportMonthlyAdvance($start_date, $end_date, 'DRR', $site);
            $monthly_drr_report_Support_ontime = reportMonthlyOnTime($start_date, $end_date, 'DRR', $site);
            $monthly_drr_report_Support_delayinComplted = reportMonthlyDelay($start_date, $end_date, 'DRR', $site);
            ...
            $objPHPExcel->getActiveSheet()->getStyle("A$row:J$row")->applyFromArray($style);
            ...
            $objPHPExcel->getActiveSheet()->getStyle("A$row:J$row")->applyFromArray($bold);
            ...
            $col++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, "Advance");
            $col++;
            ...
            $col++;
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $monthly_csr_report_Support_adv );
            $col++;
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $monthly_csr_report_Support_ontime );
            $col++;
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $monthly_csr_report_Support_delay );
            $col++;
            ...
            $col++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $monthly_cpr_report_Support_Completed + $monthly_cpr_report_Support_delayinComplted);
            $col++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $monthly_cpr_percentage);
            $col++;
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $monthly_cpr_report_Support_adv );
            $col++;
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $monthly_cpr_report_Support_ontime );
            $col++;
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $monthly_cpr_report_Support_delayinComplted );
            $col++;
            ...
            $col++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $monthly_drr_report_Support_Completed + $monthly_drr_report_Support_delayinComplted);
            $col++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $monthly_drr_percentage);
            $col++;
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $monthly_drr_report_Support_adv );
            $col++;
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $monthly_drr_report_Support_ontime );
            $col++;
			$objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col, $row, $monthly_drr_report_Support_delayinComplted );
            $col++;
...
function setDate($month){
    ...
    if($current_month > 6)
    {
        ...
        case 'July':
            // code...
          //  $prev       =  $current_year;
            $start_date = "$current_year-06-16";
            $end_date   = "$current_year-07-15";
            break;
        case 'August':
            // code...
           // $prev       =  $current_year;
            $start_date = "$current_year-07-16";
            $end_date   = "$current_year-08-15";
            break;
        case 'September':
            // code...
            //$prev       =  $current_year;
            $start_date = "$current_year-08-16";
            $end_date   = "$current_year-09-15";
            break;
        case 'October':
            // code...
        //    $prev       =  $current_year;
            $start_date = "$current_year-09-16";
            $end_date   = "$current_year-10-15";
            break;
        case 'November':
            // code...
          //  $prev       =  $current_year - 1;
            $start_date = "$current_year-10-16";
            $end_date   = "$current_year-11-15";
            break;
        case 'December':
            // code...
        //    $prev       =  $current_year - 1;
            $start_date = "$current_year-11-16";
            $end_date   = "$current_year-12-15";
            break;

        case 'January':
            // code...
            $ahead      =  $current_year  + 1;
            $start_date = "$current_year-12-16";
            $end_date   = "$ahead-01-15";
            break;
        case 'February':
            // code..
            $ahead      = $current_year + 1;
            $start_date = "$ahead-01-16";
            $end_date   = "$ahead-02-15";
            break;
        case 'March':
            // code...
            $ahead      = $current_year + 1;
            $start_date = "$ahead-02-16";
            $end_date   = "$ahead-03-15";
            break;
        case 'April':
            // code...
            $ahead      = $current_year + 1;
            $start_date = "$ahead-03-16";
            $end_date   = "$ahead-04-15";
            break;
        case 'May':
            // code...+
            $ahead      = $current_year + 1;
            $start_date = "$ahead-04-16";
            $end_date   = "$ahead-05-15";
            break;
        case 'June':
            // code...
            $ahead      = $current_year + 1;
            $start_date = "$ahead-05-16";
            $end_date   = "$ahead-06-15";
            break;
    ...
    echo $current_month." this is cur month";
